...
public class UniRate : MonoBehaviour {
	...
	/// </summary>
	/// <value>The message title you set. Default value is "Rate {<see cref="applicationName"/>}"</value>
	public string MessageTitle { 
		get { 
			return (string.IsNullOrEmpty(messageTitle)) ? string.Format(kDefaultTitle,applicationName) : messageTitle; 
		} 
	}
	...
	/// </summary>
	/// <value>The message body you set. Default value is "If you enjoy {<see cref="applicationName"/>}, would you mind taking a moment to rate it? It will not take more than a minute. Thanks for your support!"</value>
	public string Message {
		get {
			return (string.IsNullOrEmpty(message)) ? string.Format(kDefaultMessage,applicationName) : message; 
		}
	}
	...
	/// </summary>
	/// <value>The cancel button text. Default value is "No, Thanks"</value>
	public string CancelButtonLabel {
		get {
			return (string.IsNullOrEmpty(cancelButtonLabel)) ? kDefaultCancelBtnTitle : cancelButtonLabel; 
		}
	}
	...
	/// </summary>
	/// <value>The remind button text. Default value is "Remind Me Later"</value>
	public string RemindButtonLabel {
		get {
			return (string.IsNullOrEmpty(remindButtonLabel)) ? kDefaultRemindBtnTitle : remindButtonLabel; 
		}
	}
	...
	/// </summary>
	/// <value>The rate button text. Default value is "Rate It Now"</value>
	public string RateButtonLabel {
		get {
			return (string.IsNullOrEmpty(rateButtonLabel)) ? kDefaultRateBtnTitle : rateButtonLabel; 
		}
	}
	...
	public void PromptIfNetworkAvailable() {
		if (!_currentChecking) {
			...
			#if UNITY_IOS
				StartCoroutine(CheckForConnectivityInBackground());
			#elif UNITY_ANDROID
				ReadyToPrompt();
            #elif UNITY_WP8
                ReadyToPrompt();
	...
	IEnumerator CheckForConnectivityInBackground() {
		...
		yield return www;
		if (www.error == null) { //No error. Try parse app info from the returned text
